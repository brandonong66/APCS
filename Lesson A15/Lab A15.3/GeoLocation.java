...
public class GeoLocation 
{
    ...
    {
        //your code goes here
        double theta = Math.sin(Math.toRadians(latitude)) * Math.sin(Math.toRadians(other.getLatitude()))
        +Math.cos(Math.toRadians(latitude)) * Math.cos(Math.toRadians(other.getLatitude())) *
        Math.cos(Math.toRadians(longitude)-Math.toRadians(other.getLongitude()));
