...
public class Product {
	...
	/**
	 * Constructor to initialize all the fields and calculate the sale price after
	 * discount
	 * 
	 * @param pName
	 *            - product name
	...
	// The fields are initialized as described above when there is a discount and
	// calculate
	// the sale price

	Product(String pName, double pCost, double price, double pDiscount, int qty) {
		name = pName;
		cost = pCost;
		unitPrice = price;
		discount = pDiscount;
	...
	/**
	 * Constructor to initialize all the fields and calculate the sale price when
	...
	// The fields are initialized as described above when there is NO discount and
	// calculate
	// the sale price

	Product(String pName, double pCost, double price, int qty) {
		name = pName;
		cost = pCost;
		unitPrice = price;
	...
	public double calculateSalePrice() {
		double salePrice = unitPrice * (1.0 - (discount / 100));
		return salePrice;
	}
	...
	/**
	 * Modifies the discount rate and recalculates the sale price after applying the
	 * new discount
	 * 
	 * @param pDiscount
	 ...
	 */
	// Your code to calculate and return the profit on the given quantity sold goes
	// here
	public double totalProfit() {
		double totalProfit = unitProfit() * quantitySold;
		return totalProfit;
	}
